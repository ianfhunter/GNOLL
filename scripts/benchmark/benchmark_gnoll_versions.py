...
stored_count = 0
stored = [
    15.959553718566895, 4.039726257324219, 4.144654273986816, 2.02181339263916, 2.6558542251586914, 4.502716064453125, 26.067476272583008, 190.7038116455078, 1894.7485908865929, 23813.859303792316, None
]
...
bm.add_function("GNOLL Before", None, override=stored_measurements, color="r", marker="x")
