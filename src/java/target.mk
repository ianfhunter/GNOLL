...
java: clean yacc lex compile $(OBJECTS)
	...
	cd src/java; LD_LIBRARY_PATH=$(PWD)/src/java/ javac -cp ".:$(PWD)/src/java/org/" Test.java
	cd src/java; LD_LIBRARY_PATH=$(PWD)/src/java/ java -cp ".:$(PWD)/src/java/org/" Test #test.java
